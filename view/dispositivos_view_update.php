                    ...
                    <?php } else { ?>
                        <tr>
                            <form action="index.php">
                                ...
                                <input type="hidden" name="ip_original" value="<?= $dispositivo['ip']; ?>">

                                <td></td>
                                <td><input type="image" src="img/accept.png" width="18" height="18" onclick="window.location='index.php?classe=Dispositivos&metodo=atualizar&ip=<?= $dispositivo['ip'] ?>';"/></td>
                                <td><input type="text" name="hostname" value="<?= $dispositivo['hostname']; ?>"></td>
                                <td><input type="text" name="ip" value="<?= $dispositivo['ip']; ?>"></td>
                                <td><input type="text" name="tipo" value="<?= $dispositivo['tipo']; ?>"></td>
                                <td><input type="text" name="fabricante" value="<?= $dispositivo['fabricante']; ?>"></td>
                                <td></td>
                            </form>
                        </tr>
                    <?php }
